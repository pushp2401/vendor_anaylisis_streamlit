...
uploaded_files = st.file_uploader('''Upload 2 pdf files simultaneously -<br>1.company_finanicials.pdf : Document containing financial report of company <br> 2.tender_details.pdf : pdf document contaning tender details, type=["pdf"], accept_multiple_files=True)
if uploaded_files:
